    ...
    <div className="bg-slate-900">
      <div className="relative z-20 flex justify-between h-32 px-10 py-8 i">
        <div className="text-slate-300 flex flex-col items-start">
          <div className="text-xl font-extrabold">Visit Our New Courses</div>
          <div className="text-2xl font-extrabold">Enjoy 20% discount</div>
          <p className="mt-2 max-w-md text-lg">Explore new horizons</p>
        </div>
      </div>
